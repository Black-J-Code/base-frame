...
public class MysqlCodeGenerator {
     ...
     * 表名
     */
    private static final String TABLE_NAMES = "rule_condition";
    // 项目目录相对路径
     ...
     * 项目目录绝对路径
     */
    private static final String PROJECT_PATH = "/Users/yuqing.liu/YuqingLiu/code/aylaasia-business-platform";
...
//                .setSuperControllerClass("")
    ...
    private static DataSourceConfig createDataSourceConfig() {
        ...
        dataSourceConfig
                ...
                .setUrl("jdbc:mysql://localhost:3306/lyq?useUnicode=true&useSSL=false&serverTimezone=Asia/Shanghai&characterEncoding=utf8")
                .setUsername("user_lyq")
